...
![Log Scaled Price](./img/log_scaled_price.png)
...
![Outlier Multiplier Gif](./img/outlier_multiplier.gif)
...
![Boxplot Category](./img/boxplot_category.png)
*Şəkil: Original Raw Data-da Tikili kateqoriyasına görə qiymət paylanması və outlier-lər.*

![Boxplot Category Outlier Cleaned](./img/boxplot_category_outlier.png)
*Şəkil: Outlier-lər təmizləndikdən sonra Tikili kateqoriyasına görə qiymət paylanması və outlier-lər.*

![Boxplot Category Log Scaling](./img/boxplot_category_scaling.png)
*Şəkil: Log Scalingdən sonra Tikili kateqoriyasına görə qiymət paylanması və outlier-lər.*
...
![Scatter Plot Title Deed with outliers](./img/scatter_plot_price_area_title.png)
*Şəkil: Outlier-lərlə birlikdə sənədli və sənədsiz evlərin sahə/qiymət uyğunluğu.*

![Scatter Plot Title Deed](./img/scatter_plot_title_deed.png)
...
![Slope Interactive Gif](./img/slope_interactive.gif)
...
![Repair vs Price](./img/repair_vs_price.png)
...
Eyni qaydada daha detallı baxmaq üçünsə sample olaraq seçilmiş datadan istifadə edərək qurulmuş Strip plot bizə yeni tikililərdə əsasən 20 civarında mərtəbələrin sayının olduğunu, köhnə tikililərdə isə 5 və 10 mərtəbəli binaların əksəriyyəti formalaşdırdığını göstərir.

![Violin Plot Floors](./img/violin_plot_floors.png)
*Şəkil: Kateqoriyalar üzrə bina mərtəbə sayının paylanma sıxlığı. Violinplot*

![Strip Plot Floors](./img/strip_plot_floors.png)
*Şəkil: Kateqoriyalar üzrə bina mərtəbə sayının paylanma sıxlığı. Stripplot*
